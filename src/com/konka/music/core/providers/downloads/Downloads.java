...
public final class Downloads implements BaseColumns {
	public static final String PROJECT_PACKAGENAME = "com.konka.music";// 项目包名

	/**
	 * DownloadProvider authority
	 */
	public static final String AUTHORITY = PROJECT_PACKAGENAME + ".downloads";
	...
	/**
	 * 允许下载 The permission to access the download manager
	 * 
	 * @hide
	 */
	public static final String PERMISSION_ACCESS = PROJECT_PACKAGENAME + ".permission.ACCESS_DOWNLOAD_MANAGER";
	 ...
	 * @hide
	 */
	public static final String PERMISSION_ACCESS_ADVANCED = PROJECT_PACKAGENAME + ".permission.ACCESS_DOWNLOAD_MANAGER_ADVANCED";

	/**
	 * The permission to access the all the downloads in the manager.
	 */
	public static final String PERMISSION_ACCESS_ALL = PROJECT_PACKAGENAME + ".permission.ACCESS_ALL_DOWNLOADS";
	 ...
	 * @hide
	 */
	public static final String PERMISSION_SEND_INTENTS =PROJECT_PACKAGENAME + ".permission.SEND_DOWNLOAD_COMPLETED_INTENTS";

	/**
	 * 不显示通知的权限 The permission to download files without any system notification being shown.
	 */
	public static final String PERMISSION_NO_NOTIFICATION = PROJECT_PACKAGENAME + ".permission.DOWNLOAD_WITHOUT_NOTIFICATION";
	...
	/**
	 * 一般是一个文件名 The name of the column containing the filename where the downloaded data was actually stored.
	 * <P>
	 * Type: TEXT
	 * </P>
	 * <P>
	...
	/**
	 * This download will be saved to the location given by the file URI in {@link #COLUMN_FILE_NAME_HINT}.
	 */
	...
	/*
	 * Lists the states that the download manager can set on a download to notify applications of the download progress. The codes follow the HTTP families:<br> 1xx: informational<br> 2xx: success<br> 3xx: redirects (not used by the download manager)<br> 4xx: client errors<br> 5xx: server errors
	 */
	...
	/**
	 * This download couldn't be completed because of a storage issue. Typically, that's because the filesystem is missing or full. Use the more specific {@link #STATUS_INSUFFICIENT_SPACE_ERROR} and {@link #STATUS_DEVICE_NOT_FOUND_ERROR} when appropriate.
	 * 
	 * @hide
	 */
	...
	public static class RequestHeaders {
		...
		/**
		 * Prefix for ContentValues keys that contain HTTP header lines, to be passed to DownloadProvider.insert().
		 */
