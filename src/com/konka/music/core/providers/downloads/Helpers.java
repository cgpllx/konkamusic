...
public class Helpers {
	...
	private static String generateFilePath(String basePath, String url, String contentDisposition, String contentLocation, String mimeType, int destination, long contentLength) throws GenerateSaveFileError {
		String filename = chooseFilename(url, null, contentDisposition, contentLocation, destination);
