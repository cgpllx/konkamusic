...
public class TrackDetailDialogFragment extends DialogFragment {
	private static final String TAG = TrackDetailDialogFragment.class.getSimpleName();
	...
	public static TrackDetailDialogFragment newInstance(MusicInfo track) {
		TrackDetailDialogFragment f = new TrackDetailDialogFragment();
		Bundle args = new Bundle();
		args.putString(SONG_NAME, track.getTitle());
		args.putString(SONG_DURATION, TimeHelper.milliSecondsToFormatTimeString(track.getDuration()));
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		return new AlertDialog.Builder(getActivity())//
				.setTitle(R.string.song_infomation)//
				.setView(mView_vg_rootView)//
	...
	private void findViews() {
		...
		mView_vg_rootView = (ViewGroup) inflater.inflate(R.layout.track_detail_dialog, null, false);
		mView_tv_SongName = (TextView) mView_vg_rootView.findViewById(R.id.track_detail_name);
		mView_tv_SongDuration = (TextView) mView_vg_rootView.findViewById(R.id.track_detail_song_duration);
		mView_tv_Artist = (TextView) mView_vg_rootView.findViewById(R.id.track_detail_artist);
		mView_tv_FileSize = (TextView) mView_vg_rootView.findViewById(R.id.track_detail_file_size);
		mView_tv_FilePath = (TextView) mView_vg_rootView.findViewById(R.id.track_detail_file_path);
	}
